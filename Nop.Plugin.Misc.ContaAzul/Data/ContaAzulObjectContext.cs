...
{
    public class ContaAzulObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public ContaAzulObjectContext(string nameOrConnectionString)
        ...
        {
            //drop the table
           // var tableName = this.GetTableName<Custom>();
